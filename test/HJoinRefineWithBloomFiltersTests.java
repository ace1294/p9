...
import gamma.*;
import gammaSupport.*;
import graphs.HJoinRefineWithBloomFilters;
 ...
 * @author Jason
 */
public class HJoinRefineWithBloomFiltersTests {
    public void join(String r1name, String r2name, int jk1, int jk2) throws Exception {      
        ...
        HJoinRefineWithBloomFilters hj = new HJoinRefineWithBloomFilters(c1, c2, jk1, jk2, o);
        Print p = new Print(o);
        ThreadList.run(p);
    }
